<!-- Modal toggle -->
    <button id="editModalButton" data-modal-target="editModal" data-modal-toggle="editModal" type="button">
    Create product
    </button>
<!-- Main modal -->
<div id="editModal" tabindex="-1" aria-hidden="true" class="hidden fixed overflow-y-auto  top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
