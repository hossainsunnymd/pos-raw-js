...
<!-- Main modal -->
<div id="create-catagory-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="create-catagory-modal">
            ...
            <form class="p-4 md:p-5" id="form">
                ...
                <button onclick="createCategory()" data-modal-toggle="create-catagory-modal" type="button"
