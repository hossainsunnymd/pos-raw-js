...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Maximize Sales, Lead with Impact</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Empower your sales team with proven strategies to boost performance and drive results. Foster leadership that inspires success, strengthens customer relationships, and achieves sustainable growth.</p>
    </div>
